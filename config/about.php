    ...
    'sections' => [
        'hero' => [
            ...
            'fields' => [
                ...
                'recognitions' => [
                    ...
                    'fields' => [
                        ...
                        'url' => ['label' => 'Name / card link', 'type' => 'link', 'max' => 2048],
                        'link_target' => [
                            'label' => 'Open link in',
                            'type' => 'select',
                            'options' => ['same' => 'Same tab', 'new' => 'New tab'],
                        ],
            ...
            'content' => [
                ...
                'recognitions' => [
                    ['_key' => 'kush-verma', 'category' => 'Bureaucrat', 'name' => 'Kush Verma, IAS', 'url' => '', 'link_target' => 'same', 'title' => 'Former Principal Secretary, Govt. of UP · Director, LBSNAA · Author', 'quote' => ''],
                    ['_key' => 'manoj-bharti', 'category' => 'Bureaucrat', 'name' => 'Manoj K. Bharti', 'url' => '', 'link_target' => 'same', 'title' => 'Indian Foreign Service · 1984 batch', 'quote' => ''],
                    ['_key' => 'sanjay-kumar', 'category' => 'Bureaucrat', 'name' => 'Sanjay Kumar', 'url' => '', 'link_target' => 'same', 'title' => 'Director General, Forests (India) · Climate Parliament Advisor, UN', 'quote' => ''],
                    ['_key' => 'gopal-singh', 'category' => 'Bureaucrat', 'name' => 'Gopal Singh, IAS', 'url' => '', 'link_target' => 'same', 'title' => 'CMD, Coal India', 'quote' => ''],
                    ['_key' => 'ashok-kumar', 'category' => 'Bureaucrat', 'name' => 'Ashok Kumar, IPS', 'url' => '', 'link_target' => 'same', 'title' => 'Indian Police Service · 1984 batch', 'quote' => ''],
                    ['_key' => 'ajay-kumar-chauhan', 'category' => 'Bureaucrat', 'name' => 'Ajay Kumar Chauhan, IRS', 'url' => '', 'link_target' => 'same', 'title' => 'Principal Commissioner, GST · 1984 batch', 'quote' => ''],
                    ['_key' => 'kp-shashidharan', 'category' => 'Bureaucrat', 'name' => 'K. P. Shashidharan', 'url' => '', 'link_target' => 'same', 'title' => 'Former Director General of Audit (Central) · Indian Audit & Accounts Service (IA&AS)', 'quote' => ''],
                    ['_key' => 'vivek-kumar', 'category' => 'Academic', 'name' => 'Prof. Vivek Kumar', 'url' => '', 'link_target' => 'same', 'title' => 'Sociologist & public intellectual · Chairperson, School of Social Sciences, JNU', 'quote' => ''],
                    ['_key' => 'yogendra-yadav', 'category' => 'Academic', 'name' => 'Yogendra Yadav', 'url' => '', 'link_target' => 'same', 'title' => 'Psephologist & social observer', 'quote' => ''],
                    ['_key' => 'romila-thapar', 'category' => 'Academic', 'name' => 'Romila Thapar', 'url' => '', 'link_target' => 'same', 'title' => 'Historian', 'quote' => ''],
                    ['_key' => 'kanwal-rekhi', 'category' => 'Entrepreneur', 'name' => 'Kanwal Rekhi', 'url' => '', 'link_target' => 'same', 'title' => 'Venture capitalist & angel investor', 'quote' => ''],
                    ['_key' => 'robert-croci', 'category' => 'Entrepreneur', 'name' => 'Robert Croci', 'url' => '', 'link_target' => 'same', 'title' => 'Director, Public Investment Fund (UAE)', 'quote' => ''],
                ],
            ],
        ],
        'profile' => [
