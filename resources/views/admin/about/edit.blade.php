...
@section('title', 'About Anmol Goel')
    ...
    <div class="cms-page">
        <header class="cms-page-header">
            <div>
                ...
                <h2>Manage the About Anmol Goel page</h2>
                <p>Edit the recognition hero, profile facts, About copy, rotating quotes, footer links, SEO, publishing state, images, visibility, and ordering.</p>
            </div>

            <a class="cms-button cms-button-secondary" href="{{ route('about') }}" target="_blank" rel="noopener">
                View About page ↗
            </a>
        </header>
        ...
        @if ($errors->any())
            <div class="cms-alert cms-alert-error">
                <strong>The About page was not saved.</strong>
        ...
        <div class="cms-layout">
            <aside class="cms-section-index">
                ...
                <nav>
                    <a href="#about-seo">SEO & Publishing</a>
            ...
            <div class="cms-editor">
                ...
                >
                    ...
                    <section class="cms-section-card" id="about-seo">
                        ...
                        <div class="cms-section-body">
                            <div class="cms-fields-grid">
                                ...
                                <div class="cms-field cms-field-wide">
                                    ...
                                    <small>Turning this off makes the public About page return 404.</small>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="cms-savebar">
                        ...
                        <button class="cms-button cms-button-primary" type="submit">Save About page</button>
                    </div>
                </form>
            </div>
        </div>
