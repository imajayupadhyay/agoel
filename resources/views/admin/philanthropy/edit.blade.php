...
@section('page-title', 'Philanthropy')
    ...
    <div class="cms-page">
        <header class="cms-page-header">
            <div>
                ...
                <h2>Manage the Philanthropy page</h2>
                <p>Edit every section, organization, principle, image, visibility state, and display order from one workspace.</p>
            </div>

            <a class="cms-button cms-button-secondary" href="{{ route('philanthropy') }}" target="_blank" rel="noopener">
                View Philanthropy page ↗
            </a>
        </header>
        ...
        @if ($errors->any())
            <div class="cms-alert cms-alert-error">
                <strong>The Philanthropy page was not saved.</strong>
        ...
        <div class="cms-layout">
            <aside class="cms-section-index">
                ...
                <nav>
                    <a href="#philanthropy-seo">SEO & Publishing</a>
            ...
            <div class="cms-editor">
                <form
                    id="philanthropy-form"
                    data-cms-form
                    method="POST"
                    action="{{ route('admin.philanthropy.update') }}"
                    enctype="multipart/form-data"
                >
                    @csrf
                    @method('PUT')

                    <section class="cms-section-card" id="philanthropy-seo">
                            ...
                            <div class="cms-fields-grid">
                                ...
                                <div class="cms-field cms-field-wide">
                                    <label class="cms-check">
                                        ...
                                        Philanthropy page is published
                                    </label>
                                    <small>Turning this off makes the public Philanthropy page return 404.</small>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="cms-savebar">
                        ...
                        <button class="cms-button cms-button-primary" type="submit">Save Philanthropy page</button>
                    </div>
                </form>
            </div>
        </div>
