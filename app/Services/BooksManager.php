...
class BooksManager
{
    public function __construct(
        private readonly BooksSchema $schema,
        private readonly BooksMedia $media,
    ) {}

    public function update(Page $page, UpdateBooksRequest $request): void
    {
